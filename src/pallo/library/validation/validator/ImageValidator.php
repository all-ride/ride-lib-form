...
use pallo\library\image\io\ImageFactory;
...
class ImageValidator extends AbstractValidator {
     ...
     * @var pallo\library\image\io\ImageFactory
     */
     ...
     * @param pallo\library\image\ImageFactory $imageFactory
     * @return null
     */
    ...
    public function isValid($value) {
        ...
        if (!$this->fileBrowser) {
            throw new Exception('This validator has no pallo\\library\\system\\file\\browser\\FileBrowser set.');
        }

        if (!$this->imageFactory) {
            throw new Exception('This validator has no pallo\\library\\image\\io\\ImageFactory set.');
        }
